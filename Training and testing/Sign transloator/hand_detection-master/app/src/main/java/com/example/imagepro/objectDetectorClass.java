...
public class  objectDetectorClass {
    ...
    objectDetectorClass(AssetManager assetManager,String modelPath, String labelPath,int inputSize, String classification_model, int classification_input_size) throws IOException{
        ...
        options2.setNumThreads(2);//model
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5) {
               ...
               ; }
                ...
                Rect cropped_rio=new Rect((int)x1,(int)y1,(int)w1,(int)h1);
                Mat cropped=new Mat(rotated_mat_image,cropped_rio).clone();
                Bitmap bitmap1=null;
    ...
    private ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        ...
        for (int i=0;i<size_images;++i){
            for (int j=0;j<size_images;++j){
                ...
                if(quant==0){
                    byteBuffer.put((byte) ((val>>16)));
                    byteBuffer.put((byte) ((val>>8)));
